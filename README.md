...
- Le vérificateur de mots essaie d'abord de charger la liste `ods8.txt` située à la racine du projet. Pour que cela fonctionne, servez le dossier via HTTP (ex. `python3 -m http.server 8000`) puis ouvrez `http://127.0.0.1:8000/index.html`.
